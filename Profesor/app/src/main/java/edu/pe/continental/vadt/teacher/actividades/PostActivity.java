...
import edu.pe.continental.vadt.teacher.providers.ImageProvider;
import edu.pe.continental.vadt.teacher.providers.PostProvider;
import edu.pe.continental.vadt.teacher.utils.FileUtil;
...
public class PostActivity extends AppCompatActivity {
    ...
    private void clearForm() {
        ...
        mImageViewPost1.setImageResource(R.drawable.ic_description);
        mImageViewPost2.setImageResource(R.drawable.ic_description);
        mTitle = "";
        mDescription = "";
        mCategory = "";
        mImageFile = null;
